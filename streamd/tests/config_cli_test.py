    ...
    [
        ...
        (
            [
                ...
                ("--append_protein_selection", {"type": list, "default": None}),
                ("--debug", {"action": "store_true", "default": False}),
                ("--ncpu", {"type": int, "default": 1}),
            ],
            {"ligand_id": "ABC", "ncpu": 4, "unused": "x", "append_protein_selection": "'resn MG' 'resn ZN'"},
            ["--tpr", "file.tpr", "--xtc", "file.xtc", "--debug"],
            {
                "tpr": "file.tpr",
                "xtc": "file.xtc",
                "append_protein_selection": ['resn MG', 'resn ZN'],
                "ligand_id": "ABC",
                "debug": True,
                "ncpu": 1,
            },
